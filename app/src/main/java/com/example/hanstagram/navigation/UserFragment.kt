...
import com.example.hanstagram.LoginActivity
import com.example.hanstagram.MainActivity
import com.example.hanstagram.R
import com.example.hanstagram.navigation.model.ContentDTO
import com.example.hanstagram.navigation.model.FollowDTO
...
class UserFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        fragmentView?.account_iv_profile?.setOnClickListener {
            ...
            changeProfileLauncher.launch(photoPickerIntent)
        }
        getProfileImage()
    ...
    var changeProfileLauncher = registerForActivityResult<Intent, ActivityResult>(
